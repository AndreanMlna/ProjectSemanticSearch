...
def log_evaluation(model_name: str, question: str, answer: str, ground_truth: str, latency: float, sources_count: int,
                   similarity_score: float, contexts: list = None):

    # Dapatkan direktori tempat script ini berada (evaluate/)
    ...
    file_path = os.path.join(folder_path, "benchmark_results_try3.csv")
