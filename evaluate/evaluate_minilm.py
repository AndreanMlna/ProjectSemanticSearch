...
MODEL_PATH = os.path.join(ROOT, "output", "minilm-dokumen-arsip")
...
def run_evaluation():
    ...
    if not os.path.exists(MODEL_PATH):
        print(f"[!] Folder model tidak ditemukan. Jalankan train_minilm.py dulu!")
        return
    ...
    # 4. Jalankan Evaluasi
    print("[*] Memulai evaluasi MiniLM...")
    results = evaluator(model)

    # 5. Tampilkan Hasil
    print("\n" + "=" * 40)
    print(f" HASIL EVALUASI MINILM")
    print("=" * 40)
    ...
    # Simpan hasil
    output_json = os.path.join(ROOT, "output", "evaluation_minilm_results.json")
