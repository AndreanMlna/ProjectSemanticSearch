...
def run_ragas_evaluation():
    ...
    csv_path = os.path.join(OUTPUT_DIR, "benchmark_results_llama_v4.csv")
    report_path = os.path.join(OUTPUT_DIR, "ragas_report_llama_v4.csv")

    # PERBAIKAN 1: Gunakan model embedding khusus juri yang lebih pintar secara semantik.
    # Jangan gunakan model lokal yang sedang Anda uji agar penilaian objektif dan toleran terhadap jawaban panjang.
